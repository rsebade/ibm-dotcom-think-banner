...
import {Header,HeaderContainer, HeaderGlobalBar, HeaderMenuButton,SkipToContent} from 'carbon-components-react';
import { IbmLogo } from '@carbon/ibmdotcom-react';
 ...
 * @param {string} props.hasBanner Determines whether to render announcement band
...
Masthead.propTypes = {
  ...
  /**
   * `true` to render Banner component. The data for the announcement band is pulled from a translation file controlled by the Carbon for IBM team. This will have no effect if an announcement is not currently active.
   */
